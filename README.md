...
Exposes the full [100Hires API v2](https://100hires.com/api) as **123 MCP tools**, enabling AI assistants to manage candidates, jobs, applications, interviews, messages, and more.
